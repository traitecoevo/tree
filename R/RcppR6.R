...
## Version: 0.2.4
## Hash: 2f6fdcb61cb869e4b3e5507a5d767af0
...
`Leaf` <- function(vcmax_25, c, b, psi_crit, jmax_25, hk_s, a, curv_fact_elec_trans, curv_fact_colim, GSS_tol_abs, vulnerability_curve_ncontrol, ci_abs_tol, ci_niter) {
  Leaf__ctor(vcmax_25, c, b, psi_crit, jmax_25, hk_s, a, curv_fact_elec_trans, curv_fact_colim, GSS_tol_abs, vulnerability_curve_ncontrol, ci_abs_tol, ci_niter)
}
.R6_Leaf <-
  R6::R6Class(
    "Leaf",
  ...
  R6::R6Class(
    ...
    public=list(
      ...
      get_atm_vpd = function() {
        FF16_Environment__get_atm_vpd(self)
      },
      get_ca = function() {
        FF16_Environment__get_ca(self)
      },
      get_leaf_temp = function() {
        FF16_Environment__get_leaf_temp(self)
      },
      get_atm_o2_kpa = function() {
        FF16_Environment__get_atm_o2_kpa(self)
      },
      get_atm_kpa = function() {
        FF16_Environment__get_atm_kpa(self)
      },

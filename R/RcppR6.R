...
## Version: 0.2.4
## Hash: 1c8c9abea98ef0ece8065e2a956bb4cc
...
`Leaf` <- function(vcmax_25, c, b, psi_crit, beta1, beta2, jmax_25, hk_s, a, curv_fact_elec_trans, curv_fact_colim, GSS_tol_abs, vulnerability_curve_ncontrol, ci_abs_tol, ci_niter) {
  Leaf__ctor(vcmax_25, c, b, psi_crit, beta1, beta2, jmax_25, hk_s, a, curv_fact_elec_trans, curv_fact_colim, GSS_tol_abs, vulnerability_curve_ncontrol, ci_abs_tol, ci_niter)
}
.R6_Leaf <-
  R6::R6Class(
    "Leaf",
...
OdeRunner <- function(T) {
  type <- c(T)
  valid <- list("OdeRunner<Lorenz>"="Lorenz", "OdeRunner<OdeR>"="OdeR", "OdeRunner<FF16>"="FF16", "OdeRunner<TF24>"="TF24", "OdeRunner<FF16r>"="FF16r", "OdeRunner<K93>"="K93")
  constructors <- list("OdeRunner<Lorenz>"=`OdeRunner<Lorenz>`, "OdeRunner<OdeR>"=`OdeRunner<OdeR>`, "OdeRunner<FF16>"=`OdeRunner<FF16>`, "OdeRunner<TF24>"=`OdeRunner<TF24>`, "OdeRunner<FF16r>"=`OdeRunner<FF16r>`, "OdeRunner<K93>"=`OdeRunner<K93>`)
...
Individual <- function(T, E) {
  type <- c(T, E)
  valid <- list("Individual<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "Individual<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "Individual<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "Individual<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("Individual<FF16,FF16_Env>"=`Individual<FF16,FF16_Env>`, "Individual<TF24,TF24_Env>"=`Individual<TF24,TF24_Env>`, "Individual<FF16r,FF16_Env>"=`Individual<FF16r,FF16_Env>`, "Individual<K93,K93_Env>"=`Individual<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
IndividualRunner <- function(T, E) {
  type <- c(T, E)
  valid <- list("IndividualRunner<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "IndividualRunner<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "IndividualRunner<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "IndividualRunner<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("IndividualRunner<FF16,FF16_Env>"=`IndividualRunner<FF16,FF16_Env>`, "IndividualRunner<TF24,TF24_Env>"=`IndividualRunner<TF24,TF24_Env>`, "IndividualRunner<FF16r,FF16_Env>"=`IndividualRunner<FF16r,FF16_Env>`, "IndividualRunner<K93,K93_Env>"=`IndividualRunner<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
Parameters <- function(T, E) {
  type <- c(T, E)
  valid <- list("Parameters<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "Parameters<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "Parameters<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "Parameters<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("Parameters<FF16,FF16_Env>"=`Parameters<FF16,FF16_Env>`, "Parameters<TF24,TF24_Env>"=`Parameters<TF24,TF24_Env>`, "Parameters<FF16r,FF16_Env>"=`Parameters<FF16r,FF16_Env>`, "Parameters<K93,K93_Env>"=`Parameters<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
Node <- function(T, E) {
  type <- c(T, E)
  valid <- list("Node<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "Node<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "Node<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "Node<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("Node<FF16,FF16_Env>"=`Node<FF16,FF16_Env>`, "Node<TF24,TF24_Env>"=`Node<TF24,TF24_Env>`, "Node<FF16r,FF16_Env>"=`Node<FF16r,FF16_Env>`, "Node<K93,K93_Env>"=`Node<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
Species <- function(T, E) {
  type <- c(T, E)
  valid <- list("Species<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "Species<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "Species<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "Species<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("Species<FF16,FF16_Env>"=`Species<FF16,FF16_Env>`, "Species<TF24,TF24_Env>"=`Species<TF24,TF24_Env>`, "Species<FF16r,FF16_Env>"=`Species<FF16r,FF16_Env>`, "Species<K93,K93_Env>"=`Species<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
Patch <- function(T, E) {
  type <- c(T, E)
  valid <- list("Patch<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "Patch<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "Patch<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "Patch<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("Patch<FF16,FF16_Env>"=`Patch<FF16,FF16_Env>`, "Patch<TF24,TF24_Env>"=`Patch<TF24,TF24_Env>`, "Patch<FF16r,FF16_Env>"=`Patch<FF16r,FF16_Env>`, "Patch<K93,K93_Env>"=`Patch<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
SCM <- function(T, E) {
  type <- c(T, E)
  valid <- list("SCM<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "SCM<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "SCM<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "SCM<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("SCM<FF16,FF16_Env>"=`SCM<FF16,FF16_Env>`, "SCM<TF24,TF24_Env>"=`SCM<TF24,TF24_Env>`, "SCM<FF16r,FF16_Env>"=`SCM<FF16r,FF16_Env>`, "SCM<K93,K93_Env>"=`SCM<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
StochasticSpecies <- function(T, E) {
  type <- c(T, E)
  valid <- list("StochasticSpecies<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "StochasticSpecies<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "StochasticSpecies<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "StochasticSpecies<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("StochasticSpecies<FF16,FF16_Env>"=`StochasticSpecies<FF16,FF16_Env>`, "StochasticSpecies<TF24,TF24_Env>"=`StochasticSpecies<TF24,TF24_Env>`, "StochasticSpecies<FF16r,FF16_Env>"=`StochasticSpecies<FF16r,FF16_Env>`, "StochasticSpecies<K93,K93_Env>"=`StochasticSpecies<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
StochasticPatch <- function(T, E) {
  type <- c(T, E)
  valid <- list("StochasticPatch<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "StochasticPatch<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "StochasticPatch<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "StochasticPatch<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("StochasticPatch<FF16,FF16_Env>"=`StochasticPatch<FF16,FF16_Env>`, "StochasticPatch<TF24,TF24_Env>"=`StochasticPatch<TF24,TF24_Env>`, "StochasticPatch<FF16r,FF16_Env>"=`StochasticPatch<FF16r,FF16_Env>`, "StochasticPatch<K93,K93_Env>"=`StochasticPatch<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
StochasticPatchRunner <- function(T, E) {
  type <- c(T, E)
  valid <- list("StochasticPatchRunner<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "StochasticPatchRunner<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "StochasticPatchRunner<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "StochasticPatchRunner<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("StochasticPatchRunner<FF16,FF16_Env>"=`StochasticPatchRunner<FF16,FF16_Env>`, "StochasticPatchRunner<TF24,TF24_Env>"=`StochasticPatchRunner<TF24,TF24_Env>`, "StochasticPatchRunner<FF16r,FF16_Env>"=`StochasticPatchRunner<FF16r,FF16_Env>`, "StochasticPatchRunner<K93,K93_Env>"=`StochasticPatchRunner<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
##' @param  soil_number_of_depths Number of soil layers to include
##' @export
`TF24_Environment` <- function(light_availability_spline_rescale_usually, soil_number_of_depths, delta_z, soil_moist_sat, K_sat, a_psi, n_psi, b_infil) {
  TF24_Environment__ctor(light_availability_spline_rescale_usually, soil_number_of_depths, delta_z, soil_moist_sat, K_sat, a_psi, n_psi, b_infil)
}
.R6_TF24_Environment <-
  R6::R6Class(
    "TF24_Environment",

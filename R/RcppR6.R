...
## Version: 0.2.4
## Hash: 043af93437cdd051ba21605b6850a1ed
...
##' Leaf model
##' @param vcmax_25 rubisco rate
##' @export
`Leaf` <- function(vcmax_25, c, b, psi_crit, beta2, jmax_25, hk_s, a, curv_fact_elec_trans, curv_fact_colim, GSS_tol_abs, vulnerability_curve_ncontrol, ci_abs_tol, ci_niter) {
  Leaf__ctor(vcmax_25, c, b, psi_crit, beta2, jmax_25, hk_s, a, curv_fact_elec_trans, curv_fact_colim, GSS_tol_abs, vulnerability_curve_ncontrol, ci_abs_tol, ci_niter)
}
.R6_Leaf <-
  R6::R6Class(
    "Leaf",
...
OdeRunner <- function(T) {
  type <- c(T)
  valid <- list("OdeRunner<Lorenz>"="Lorenz", "OdeRunner<OdeR>"="OdeR", "OdeRunner<FF16>"="FF16", "OdeRunner<TF24>"="TF24", "OdeRunner<FF16w>"="FF16w", "OdeRunner<FF16r>"="FF16r", "OdeRunner<K93>"="K93")
  constructors <- list("OdeRunner<Lorenz>"=`OdeRunner<Lorenz>`, "OdeRunner<OdeR>"=`OdeRunner<OdeR>`, "OdeRunner<FF16>"=`OdeRunner<FF16>`, "OdeRunner<TF24>"=`OdeRunner<TF24>`, "OdeRunner<FF16w>"=`OdeRunner<FF16w>`, "OdeRunner<FF16r>"=`OdeRunner<FF16r>`, "OdeRunner<K93>"=`OdeRunner<K93>`)
...
Individual <- function(T, E) {
  type <- c(T, E)
  valid <- list("Individual<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "Individual<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "Individual<FF16w,FF16_Env>"=c("FF16w", "FF16_Env"), "Individual<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "Individual<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("Individual<FF16,FF16_Env>"=`Individual<FF16,FF16_Env>`, "Individual<TF24,TF24_Env>"=`Individual<TF24,TF24_Env>`, "Individual<FF16w,FF16_Env>"=`Individual<FF16w,FF16_Env>`, "Individual<FF16r,FF16_Env>"=`Individual<FF16r,FF16_Env>`, "Individual<K93,K93_Env>"=`Individual<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
IndividualRunner <- function(T, E) {
  type <- c(T, E)
  valid <- list("IndividualRunner<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "IndividualRunner<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "IndividualRunner<FF16w,FF16_Env>"=c("FF16w", "FF16_Env"), "IndividualRunner<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "IndividualRunner<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("IndividualRunner<FF16,FF16_Env>"=`IndividualRunner<FF16,FF16_Env>`, "IndividualRunner<TF24,TF24_Env>"=`IndividualRunner<TF24,TF24_Env>`, "IndividualRunner<FF16w,FF16_Env>"=`IndividualRunner<FF16w,FF16_Env>`, "IndividualRunner<FF16r,FF16_Env>"=`IndividualRunner<FF16r,FF16_Env>`, "IndividualRunner<K93,K93_Env>"=`IndividualRunner<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
Parameters <- function(T, E) {
  type <- c(T, E)
  valid <- list("Parameters<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "Parameters<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "Parameters<FF16w,FF16_Env>"=c("FF16w", "FF16_Env"), "Parameters<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "Parameters<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("Parameters<FF16,FF16_Env>"=`Parameters<FF16,FF16_Env>`, "Parameters<TF24,TF24_Env>"=`Parameters<TF24,TF24_Env>`, "Parameters<FF16w,FF16_Env>"=`Parameters<FF16w,FF16_Env>`, "Parameters<FF16r,FF16_Env>"=`Parameters<FF16r,FF16_Env>`, "Parameters<K93,K93_Env>"=`Parameters<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
Node <- function(T, E) {
  type <- c(T, E)
  valid <- list("Node<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "Node<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "Node<FF16w,FF16_Env>"=c("FF16w", "FF16_Env"), "Node<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "Node<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("Node<FF16,FF16_Env>"=`Node<FF16,FF16_Env>`, "Node<TF24,TF24_Env>"=`Node<TF24,TF24_Env>`, "Node<FF16w,FF16_Env>"=`Node<FF16w,FF16_Env>`, "Node<FF16r,FF16_Env>"=`Node<FF16r,FF16_Env>`, "Node<K93,K93_Env>"=`Node<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
.R6_Node___TF24__TF24_Env <-
  R6::R6Class(
    ...
    active=list(
      ...
      competition_effect = function(value) {
        if (missing(value)) {
          Node___TF24__TF24_Env__competition_effect__get(self)
        } else {
          stop("Node<TF24,TF24_Env>$competition_effect is read-only")
        }
      },
      fecundity = function(value) {
        if (missing(value)) {
...
Species <- function(T, E) {
  type <- c(T, E)
  valid <- list("Species<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "Species<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "Species<FF16w,FF16_Env>"=c("FF16w", "FF16_Env"), "Species<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "Species<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("Species<FF16,FF16_Env>"=`Species<FF16,FF16_Env>`, "Species<TF24,TF24_Env>"=`Species<TF24,TF24_Env>`, "Species<FF16w,FF16_Env>"=`Species<FF16w,FF16_Env>`, "Species<FF16r,FF16_Env>"=`Species<FF16r,FF16_Env>`, "Species<K93,K93_Env>"=`Species<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
.R6_Species___TF24__TF24_Env <-
  R6::R6Class(
    ...
    public=list(
      ...
      competition_effects_error = function(scal=1) {
        Species___TF24__TF24_Env__competition_effects_error(self, scal)
      }),
    active=list(
      size = function(value) {
        if (missing(value)) {
      ...
      competition_effects = function(value) {
        if (missing(value)) {
          Species___TF24__TF24_Env__competition_effects__get(self)
        } else {
          stop("Species<TF24,TF24_Env>$competition_effects is read-only")
        }
      },
      extrinsic_drivers = function(value) {
        if (missing(value)) {
...
Patch <- function(T, E) {
  type <- c(T, E)
  valid <- list("Patch<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "Patch<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "Patch<FF16w,FF16_Env>"=c("FF16w", "FF16_Env"), "Patch<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "Patch<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("Patch<FF16,FF16_Env>"=`Patch<FF16,FF16_Env>`, "Patch<TF24,TF24_Env>"=`Patch<TF24,TF24_Env>`, "Patch<FF16w,FF16_Env>"=`Patch<FF16w,FF16_Env>`, "Patch<FF16r,FF16_Env>"=`Patch<FF16r,FF16_Env>`, "Patch<K93,K93_Env>"=`Patch<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
SCM <- function(T, E) {
  type <- c(T, E)
  valid <- list("SCM<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "SCM<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "SCM<FF16w,FF16_Env>"=c("FF16w", "FF16_Env"), "SCM<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "SCM<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("SCM<FF16,FF16_Env>"=`SCM<FF16,FF16_Env>`, "SCM<TF24,TF24_Env>"=`SCM<TF24,TF24_Env>`, "SCM<FF16w,FF16_Env>"=`SCM<FF16w,FF16_Env>`, "SCM<FF16r,FF16_Env>"=`SCM<FF16r,FF16_Env>`, "SCM<K93,K93_Env>"=`SCM<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
.R6_SCM___TF24__TF24_Env <-
  R6::R6Class(
    ...
    public=list(
      ...
      competition_effect_error = function(species_index) {
        SCM___TF24__TF24_Env__competition_effect_error(self, species_index)
      },
      set_node_schedule_times = function(times) {
    ...
    active=list(
      ...
      state = function(value) {
        if (missing(value)) {
          SCM___TF24__TF24_Env__state__get(self)
        } else {
          stop("SCM<TF24,TF24_Env>$state is read-only")
        }
      },
      aux = function(value) {
        if (missing(value)) {
          SCM___TF24__TF24_Env__aux__get(self)
        } else {
          stop("SCM<TF24,TF24_Env>$aux is read-only")
        }
      },
      use_ode_times = function(value) {
        if (missing(value)) {
...
StochasticSpecies <- function(T, E) {
  type <- c(T, E)
  valid <- list("StochasticSpecies<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "StochasticSpecies<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "StochasticSpecies<FF16w,FF16_Env>"=c("FF16w", "FF16_Env"), "StochasticSpecies<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "StochasticSpecies<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("StochasticSpecies<FF16,FF16_Env>"=`StochasticSpecies<FF16,FF16_Env>`, "StochasticSpecies<TF24,TF24_Env>"=`StochasticSpecies<TF24,TF24_Env>`, "StochasticSpecies<FF16w,FF16_Env>"=`StochasticSpecies<FF16w,FF16_Env>`, "StochasticSpecies<FF16r,FF16_Env>"=`StochasticSpecies<FF16r,FF16_Env>`, "StochasticSpecies<K93,K93_Env>"=`StochasticSpecies<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
StochasticPatch <- function(T, E) {
  type <- c(T, E)
  valid <- list("StochasticPatch<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "StochasticPatch<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "StochasticPatch<FF16w,FF16_Env>"=c("FF16w", "FF16_Env"), "StochasticPatch<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "StochasticPatch<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("StochasticPatch<FF16,FF16_Env>"=`StochasticPatch<FF16,FF16_Env>`, "StochasticPatch<TF24,TF24_Env>"=`StochasticPatch<TF24,TF24_Env>`, "StochasticPatch<FF16w,FF16_Env>"=`StochasticPatch<FF16w,FF16_Env>`, "StochasticPatch<FF16r,FF16_Env>"=`StochasticPatch<FF16r,FF16_Env>`, "StochasticPatch<K93,K93_Env>"=`StochasticPatch<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
StochasticPatchRunner <- function(T, E) {
  type <- c(T, E)
  valid <- list("StochasticPatchRunner<FF16,FF16_Env>"=c("FF16", "FF16_Env"), "StochasticPatchRunner<TF24,TF24_Env>"=c("TF24", "TF24_Env"), "StochasticPatchRunner<FF16w,FF16_Env>"=c("FF16w", "FF16_Env"), "StochasticPatchRunner<FF16r,FF16_Env>"=c("FF16r", "FF16_Env"), "StochasticPatchRunner<K93,K93_Env>"=c("K93", "K93_Env"))
  constructors <- list("StochasticPatchRunner<FF16,FF16_Env>"=`StochasticPatchRunner<FF16,FF16_Env>`, "StochasticPatchRunner<TF24,TF24_Env>"=`StochasticPatchRunner<TF24,TF24_Env>`, "StochasticPatchRunner<FF16w,FF16_Env>"=`StochasticPatchRunner<FF16w,FF16_Env>`, "StochasticPatchRunner<FF16r,FF16_Env>"=`StochasticPatchRunner<FF16r,FF16_Env>`, "StochasticPatchRunner<K93,K93_Env>"=`StochasticPatchRunner<K93,K93_Env>`)
  constructors[[check_type(type, valid)]]
}
...
.R6_StochasticPatchRunner___TF24__TF24_Env <-
  R6::R6Class(
    ...
    active=list(
      ...
      state = function(value) {
        if (missing(value)) {
          StochasticPatchRunner___TF24__TF24_Env__state__get(self)
        } else {
          stop("StochasticPatchRunner<TF24,TF24_Env>$state is read-only")
        }
      }))
...
.R6_TF24_Environment <-
  R6::R6Class(
    ...
    active=list(
      ...
      soil_number_of_depths = function(value) {
        if (missing(value)) {
          TF24_Environment__soil_number_of_depths__get(self)
        } else {
          stop("TF24_Environment$soil_number_of_depths is read-only")
        }
      },
      light_availability = function(value) {
        if (missing(value)) {
      ...
      extrinsic_drivers = function(value) {
        if (missing(value)) {
          TF24_Environment__extrinsic_drivers__get(self)
        } else {
          TF24_Environment__extrinsic_drivers__set(self, value)
        }
      }))

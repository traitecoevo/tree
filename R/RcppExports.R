...
Leaf__ctor <- function(vcmax_25, c, b, psi_crit, jmax_25, hk_s, a, curv_fact_elec_trans, curv_fact_colim, GSS_tol_abs, vulnerability_curve_ncontrol, ci_abs_tol, ci_niter) {
    .Call('_plant_Leaf__ctor', PACKAGE = 'plant', vcmax_25, c, b, psi_crit, jmax_25, hk_s, a, curv_fact_elec_trans, curv_fact_colim, GSS_tol_abs, vulnerability_curve_ncontrol, ci_abs_tol, ci_niter)
}

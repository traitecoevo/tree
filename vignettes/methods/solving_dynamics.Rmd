---
title: "Numerical methods for solving size- & patch-structured dynamics"
bibliography: ../assets/refs.bib
csl: ../assets/methods-in-ecology-and-evolution.csl
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Numerical methods for solving size- & patch-structured dynamics}
...
For this, `plant` uses an embedded implementation of Runge-Kutta Cash-Karp 4-5 algorithm [@Cash-1990], with

...
vignette: >
  %\VignetteIndexEntry{Node spacing method}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

<!-- NB:
 This file is generated from the file `vignettes/methods/node_spacing.Rmd`. Make any edits there. To regenerate

setwd("vignettes/methods")

---
title: "TF24 Leaf model - Hydraulics and optimal stomatal behaviour"
...
The TF24 strategy will include water dynamics, built off a physiological stomatal optimisation sub-model which determines how plants assimilate carbon and transpire water dynamically in response to water availability, vapour pressure deficit, leaf temperature, in a trait-dependent manner, and a soil-water submodel which takes rainfall as an input and determines how much soil moisture is available to plants.
...
Now compare these numbers to the  `TF24` implementation, (they should be the same):
